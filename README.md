...
- **Fabric Modding:** Currently maintaining/building mods for 1.20.1.
- **Personal Projects:** Experimenting with Kotlin for other uses beyond modding.
- **Learning:** Always looking for better ways to optimize my code and leverage Fabric's API.
